...
{
    [Route("api/v3/winning-rate")]
    [AllowAnonymous]
    public sealed class WinningRateController : ApiControllerBase
    {
        private readonly IAnalyticsReader _reader;

        public WinningRateController(IAnalyticsReader reader)
        {
            _reader = reader;
        }
            ...
            CancellationToken ct)
        {
            ...
            var result = await _reader.GetWinningRateAsync(query, ct);
