...
$(document).ready(function () {
    ...
    $('#earningDatetime').datepicker("setDate", new Date());
...
function renderList() {
    ...
    $.ajax({
        type: "GET",
        url: "/Analysis/EarningJson",
        data: { 'marketId': marketId, 'analysisPeriodId': analysisPeriodId, 'minRateId': minRateId, 'matchStateId': matchStateId, 'date': date, 'page': page },
        cache: false,
        beforeSend: function () {
            if (isButtonCalling) {
